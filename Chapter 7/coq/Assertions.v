...
Example abisim_abisim_context :
  forall AP b,
  entails (Astar (Aproc (APcond b AP)) (Aplain b)) (Aproc AP).
Proof.
  intros AP b.
  transitivity (Astar (Aproc (APcond b AP)) (Abisim (APcond b AP) AP)).
  - apply star_add_l. apply abisim_cond_true.
  - apply abisim_proc.
Qed.
