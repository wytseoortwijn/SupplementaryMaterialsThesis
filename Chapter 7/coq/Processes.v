...
Lemma bisim_pterm :
  forall P, pterm P -> bisim P (Palt P Pepsilon).
Proof.
  ...
  (* faulting *)
  - intros H2. vauto.
  - intros H2. inv H2. inv H0.
  (* reductions *)
  - intros P' l STEP.
    exists P'. intuition.
    by apply pstep_alt_l.
  - intros Q' l STEP. inv STEP; vauto.
    inv H4.
Qed.
...
Lemma psafe_cond :
  forall b P,
  psafe (Pcond b P) -> pcond_eval b -> psafe P.
Proof.
  intros b P H1 H2. inv H1. clear H1.
  destruct H as (H1 & H3).
  constructor. split.
  - intro H4. apply H1. constructor; vauto.
  - intros l P' STEP. apply H3 with l. vauto.
Qed.

Lemma psafe_sum_rev :
  forall f, psafe (Psum f) -> (forall v, psafe (f v)).
Proof.
  intros f H1 v. inv H1. clear H1.
  destruct H as (H1 & H2). constructor. split.
  - intro H3. apply H1. vauto.
  - intros l P' STEP. apply H2 with l.
    vauto.
Qed.
